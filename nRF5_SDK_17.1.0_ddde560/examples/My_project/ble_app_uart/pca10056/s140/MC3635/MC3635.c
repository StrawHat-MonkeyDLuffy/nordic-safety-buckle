 ...
 * @warning     N/A.
 */
MC3635_status_t MC3635_Init(TWI_parameters_t *para)
{
    ret_code_t err_code;

    err_code = TWI_Init(para);
 ...
 * @warning     N/A.
 */
MC3635_status_t MC3635_SetStandbyMode(TWI_parameters_t *para)
{
    uint8_t cmd[] = { MODE_C, 0 };

    /* Read current MODE_C register value */
    if (TWI_Write(para,
                  &cmd[0],
                  1,
                  NO_STOP_BIT) != NRF_SUCCESS)
    {
        return MC3635_FAILURE;
    }
 ...
 * @warning     N/A.
 */
MC3635_status_t  MC3635_SetSleepMode ( TWI_parameters_t *para )
{
    uint8_t cmd[] = { MODE_C, 0 };
 ...
 */
MC3635_status_t  MC3635_InitializationSequence ( TWI_parameters_t *para )
{
    uint8_t         cmd[]    =   { 0, 0 };
 ...
 *              first: MC3635_SetStandbyMode.
 */
MC3635_status_t  MC3635_WriteScratchpadRegister ( TWI_parameters_t *para, MC3635_data_t myScratchpadRegister )
{
    uint8_t         cmd[]    =   { 0, 0 };
 ...
 * @warning     N/A.
 */
MC3635_status_t  MC3635_ReadScratchpadRegister ( TWI_parameters_t *para, MC3635_data_t* myScratchpadRegister )
{
    uint8_t         cmd     =   SCRATCH;
 ...
 */
MC3635_status_t  MC3635_SetSoftwareReset ( TWI_parameters_t *para )
{
    uint8_t         cmd[]   =   { RESET , 0 };
 ...
 *              first: MC3635_SetStandbyMode.
 */
MC3635_status_t  MC3635_SetReload ( TWI_parameters_t *para )
{
    uint8_t         cmd[]        =   { RESET , 0 };
 ...
 * @warning     N/A.
 */
MC3635_status_t  MC3635_ReadExtendedStatusRegister2 ( TWI_parameters_t *para, MC3635_data_t* myExt_stat_2 )
{
 ...
 * @warning     N/A.
 */
MC3635_status_t  MC3635_ReadRawData ( TWI_parameters_t *para, MC3635_data_t* myRawData )
{
    ...
    if (TWI_Read(para,
                 &cmd[0],
                 sizeof( cmd )/sizeof( cmd[0] )) != NRF_SUCCESS)
    {
        return MC3635_FAILURE;
    }
    ...
    /* Get the range.
       ...
       NOTE: 2G and 12-bit are the reference, other values have to be
             ...
             experimentally.
    */
    MC3635_GetRange ( para, myRawData );
    ...
    /* Get the resolution.
       ...
       NOTE: 2G and 12-bit are the reference, other values have to be
             ...
             experimentally.
    */
    MC3635_GetResolution ( para, myRawData );
 ...
 * @warning     N/A.
 */
MC3635_status_t  MC3635_ReadStatusRegister1 ( TWI_parameters_t *para, MC3635_data_t* myStatus_1 )
{
 ...
 * @warning     N/A.
 */
MC3635_status_t  MC3635_ReadStatusRegister2 ( TWI_parameters_t *para, MC3635_data_t* myStatus_2 )
{
 ...
 * @warning     N/A.
 */
MC3635_status_t  MC3635_ReadFeatureRegister1 ( TWI_parameters_t *para, MC3635_data_t* myFeatureRegister1 )
{
    uint8_t         cmd   =   FREG_1;
    ...
    if (TWI_Read(para,
                 &myFeatureRegister1->FeatureRegister1,
                  1) != NRF_SUCCESS)
    {
        return MC3635_FAILURE;
    }
 ...
 * @warning     N/A.
 */
MC3635_status_t  MC3635_ReadFeatureRegister2 ( TWI_parameters_t *para, MC3635_data_t* myFeatureRegister2 )
{
    uint8_t         cmd   =   FREG_2;
    ...
    if (TWI_Read(para,
                 &myFeatureRegister2->FeatureRegister2,
                  1) != NRF_SUCCESS)
    {
        return MC3635_FAILURE;
    }
 ...
 *              first: MC3635_SetStandbyMode.
 */
MC3635_status_t  MC3635_EnableAxis ( TWI_parameters_t *para, MC3635_mode_c_x_axis_pd_t myXAxis, MC3635_mode_c_y_axis_pd_t myYAxis, MC3635_mode_c_z_axis_pd_t myZAxis )
{
    uint8_t         cmd[] =   { MODE_C, 0 };
 ...
 *              first: MC3635_SetStandbyMode.
 */
MC3635_status_t  MC3635_SetStandbyClockRate ( TWI_parameters_t *para, MC3635_sniff_c_stb_rate_t mySTANDBY_ClockRate )
{
 ...
 *              first: MC3635_SetStandbyMode.
 */
MC3635_status_t  MC3635_SetMode ( TWI_parameters_t *para, MC3635_mode_c_mctrl_t myMode, MC3635_power_mode_t myPowerMode, MC3635_sample_rate_t myODR )
{
    uint8_t         cmd[] =   { 0, 0 };
 ...
 *              first: MC3635_SetStandbyMode.
 */
MC3635_status_t  MC3635_SetTriggerMode ( TWI_parameters_t *para, MC3635_mode_c_trig_cmd_t myTriggerEnable, uint8_t myTriggerSamples,
                                         MC3635_sniff_c_stb_rate_t mySTANDBY_ClockRate )
{
    ...
    {
        /* ODR */
        MC3635_SetStandbyClockRate ( para, mySTANDBY_ClockRate );
 ...
 *              first: MC3635_SetStandbyMode.
 */
MC3635_status_t  MC3635_ManualSniffReset ( TWI_parameters_t *para, MC3635_sniffcf_c_sniff_reset_t mySniffResetBit )
{
 ...
 *              first: MC3635_SetStandbyMode.
 */
MC3635_status_t  MC3635_ConfSniffMode ( TWI_parameters_t *para, MC3635_sniffcf_c_sniff_thadr_t mySniffADR, uint8_t mySniffThreshold, MC3635_sniffth_c_sniff_and_or_t mySniffLogicalMode,
 ...
 *              first: MC3635_SetStandbyMode.
 */
MC3635_status_t  MC3635_SetResolution ( TWI_parameters_t *para, MC3635_range_c_res_t myResolution )
{
 ...
 * @warning     N/A.
 */
MC3635_status_t  MC3635_GetResolution ( TWI_parameters_t *para, MC3635_data_t* myResolution )
{
    uint8_t         cmd[] =   { RANGE_C, 0 };
 ...
 *              first: MC3635_SetStandbyMode.
 */
MC3635_status_t  MC3635_SetRange ( TWI_parameters_t *para, MC3635_range_c_range_t myRange )
{
    uint8_t         cmd[] =   { RANGE_C, 0 };
 ...
 * @warning     N/A.
 */
MC3635_status_t  MC3635_GetRange ( TWI_parameters_t *para, MC3635_data_t* myRange )
{
    uint8_t         cmd[] =   { RANGE_C, 0 };
 ...
 *              first: MC3635_SetStandbyMode.
 */
MC3635_status_t  MC3635_SetFIFO ( TWI_parameters_t *para, uint8_t myNumberOfSamples, MC3635_fifo_c_fifo_mode_t myFIFO_Mode )
{
 ...
 *              first: MC3635_SetStandbyMode.
 */
MC3635_status_t  MC3635_EnableFIFO ( TWI_parameters_t *para, MC3635_fifo_c_fifo_en_t myFIFO_Enable )
{
    uint8_t         cmd[] =   { FIFO_C, 0 };
 ...
 *              first: MC3635_SetStandbyMode.
 */
MC3635_status_t  MC3635_ResetFIFO ( TWI_parameters_t *para )
{
    uint8_t         cmd[] =   { FIFO_C, 0 };
 ...
 * @warning     N/A.
 */
MC3635_status_t  MC3635_GetGain ( TWI_parameters_t *para, MC3635_axis_t myChosenAxis, MC3635_data_t* myGain )
{
    uint8_t         cmd[]        =   { 0, 0 };
 ...
 * @warning     N/A.
 */
MC3635_status_t  MC3635_GetOffset ( TWI_parameters_t *para, MC3635_axis_t myChosenAxis, MC3635_data_t* myOffset )
{
    uint8_t         cmd[]        =   { 0, 0 };
    uint8_t         myAuxReg1, myAuxReg2;
 ...
 *              first: MC3635_SetStandbyMode.
 */
MC3635_status_t  MC3635_Conf_INTN ( TWI_parameters_t *para, MC3635_intr_c_ipp_t myINTN_ModeControl, MC3635_intr_c_iah_t myINTN_LevelControl )
{
 ...
 *              first: MC3635_SetStandbyMode.
 */
MC3635_status_t  MC3635_Set_INTN ( TWI_parameters_t *para, MC3635_intr_c_int_wake_t myINT_WakeMode, MC3635_intr_c_int_acq_t myINT_ACQMode,
