...
/** It enables/disables X/Y/Z Axis.
        */
MC3635_status_t  MC3635_EnableAxis                    ( TWI_parameters_t *para, MC3635_mode_c_x_axis_pd_t myXAxis,
                                                        MC3635_mode_c_y_axis_pd_t myYAxis, MC3635_mode_c_z_axis_pd_t myZAxis                                                        );
/** It sets the clock rate for STANDBY mode.
        */
MC3635_status_t  MC3635_SetStandbyClockRate           ( TWI_parameters_t *para, MC3635_sniff_c_stb_rate_t myStandbyCloclRate                                              );
...
/** It configures the parameters for the SNIFF mode.
        */
MC3635_status_t  MC3635_ConfSniffMode                 ( TWI_parameters_t *para, MC3635_sniffcf_c_sniff_thadr_t mySniffADR, uint8_t mySniffThreshold,
